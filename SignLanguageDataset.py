...
# Veri yolları
json_path = r"Isitme_Engeli\output_data.json"  # JSON dosyasının yolunu buraya yazın
...
def generate_video(sentence, model, label_map, data, output_video="output_video.mp4", fps=60):
